...
export function HeroLanding(props: HeroLandingProps) {
  ...
  return (
    <div className={`h-screen w-full relative ${className || ''}`}>
          ...
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              ...
              {logo?.src ? (
                ...
                <span className="text-2xl font-bold bg-gradient-to-r from-[#4F6BFF] to-[#6A7CFF] bg-clip-text text-transparent">
                  {logo?.companyName || 'HQAdz'}
                </span>
              )}
            </a>
          </div>
      ...
      <div className="relative isolate px-6 pt-4 h-screen flex flex-col justify-center">        
