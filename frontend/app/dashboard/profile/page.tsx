...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    if (!token || !role || role.toUpperCase() !== 'USER') {
      console.log('[Profile] Authentication check failed:', { token: !!token, role });
      router.push('/access');
      return;
    }
      ...
      <div className="flex-1 ml-72 relative z-10">
        ...
        >
          <div className="px-8 py-6">
            ...
            >
              Manage settings specific to your Adbot instance
            </p>
          </div>
        </header>
        <main className="p-8">
          ...
          >
            <div className="flex items-center gap-4 mb-8">
              ...
              <h2 className="text-2xl font-semibold" style={{ color: '#FFFFFF' }}>Profile Settings</h2>
            </div>
            <p className="text-sm" style={{ color: 'rgba(255, 255, 255, 0.6)' }}>Profile configuration coming soon...</p>
          </div>
        </main>
      </div>
    </div>
